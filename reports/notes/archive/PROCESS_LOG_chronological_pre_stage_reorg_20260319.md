...
- note:
  - this auto-generated midterm package was later removed from the workspace because it had not been manually re-verified against the opening report and current project results
  - `reports/midterm/README.md` and `reports/midterm/rendered/README.md` now serve as the cleaned source-of-truth guides for midterm writing
