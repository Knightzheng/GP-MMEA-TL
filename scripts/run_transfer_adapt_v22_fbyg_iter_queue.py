...
VARIANTS = {
    "v22a": {
        "config": "configs/transfer_adapt/tmmeada_target_fbyg15k_v22a_fresh_il_quality_top200.yaml",
        "stage_root": "transfer/transfer_adapt_v22_fbyg_pilot_v22a",
        "tag_prefix": "tmmeada_transfer_adapt_v22_fbyg_v22a",
        "pilot_ref_dir": ROOT / "runs/transfer/transfer_adapt_v22_fbyg_v22a_pilot_ref/target_eval",
        "full_ref_dir": ROOT / "runs/transfer/transfer_adapt_v22_fbyg_v22a_expand5_ref/target_eval",
        "transfer_skip_keys": (
    ...
    "v22b": {
        "config": "configs/transfer_adapt/tmmeada_target_fbyg15k_v22b_fresh_il_quality_top100.yaml",
        "stage_root": "transfer/transfer_adapt_v22_fbyg_pilot_v22b",
        "tag_prefix": "tmmeada_transfer_adapt_v22_fbyg_v22b",
        "pilot_ref_dir": ROOT / "runs/transfer/transfer_adapt_v22_fbyg_v22b_pilot_ref/target_eval",
        "full_ref_dir": ROOT / "runs/transfer/transfer_adapt_v22_fbyg_v22b_expand5_ref/target_eval",
        "transfer_skip_keys": (
            "multimodal_encoder.entity_emb.weight,"
            "multimodal_encoder.rel_fc.weight,"
            "multimodal_encoder.rel_fc.bias"
    ...
    "v22c": {
        "config": "configs/transfer_adapt/tmmeada_target_fbyg15k_v22c_fresh_il_quality_top300.yaml",
        "stage_root": "transfer/transfer_adapt_v22_fbyg_pilot_v22c",
        "tag_prefix": "tmmeada_transfer_adapt_v22_fbyg_v22c",
        "pilot_ref_dir": ROOT / "runs/transfer/transfer_adapt_v22_fbyg_v22c_pilot_ref/target_eval",
        "full_ref_dir": ROOT / "runs/transfer/transfer_adapt_v22_fbyg_v22c_expand5_ref/target_eval",
        "transfer_skip_keys": (
            "multimodal_encoder.entity_emb.weight,"
            "multimodal_encoder.rel_fc.weight,"
            "multimodal_encoder.rel_fc.bias"
...
def main():
    parser = argparse.ArgumentParser(description="Iterate FBYG15K v22 IL-quality variants with resumable pilot/full5 summaries.")
    parser.add_argument(
        "--run-missing",
        type=int,
        default=1,
    ...
    baseline_pilot_all_ref = ROOT / "runs/transfer/transfer_adapt_v22_fbyg_pilot_baseline_ref/target_eval"
    ...
    for key in ["v22a", "v22b", "v22c"]:
        ...
        compare_csv = None
        delta = None
        baseline_variant_ref = ROOT / "runs/transfer" / f"transfer_adapt_v22_fbyg_{key}_pilot_baseline_matched_ref" / "target_eval"
        if selected_seeds:
        ...
        if baseline_pilot_selected and selected:
            compare_csv_path = summarize_compare(
                prefix=f"transfer_adapt_v22_fbyg_pilot_{key}",
    ...
    if should_expand:
        ...
        if best_selected_seeds:
            best_baseline_ref = ROOT / "runs/transfer" / f"transfer_adapt_v22_fbyg_{best_variant}_expand5_baseline_matched_ref" / "target_eval"
        ...
        if best_baseline_selected and best_selected:
            compare_csv = summarize_compare(
                prefix=f"transfer_adapt_v22_fbyg_{best_variant}_expand5",
    ...
    out_json = ROOT / "reports/transfer/transfer_adapt_v22_fbyg_iter_decision.json"
    out_md = ROOT / "reports/transfer/transfer_adapt_v22_fbyg_iter_decision.md"
