...
VARIANTS = {
    "v17a": {
        "config": "configs/transfer_adapt/tmmeada_target_fbdb15k_v17a_no_il_balanced.yaml",
        "stage_root": "transfer/transfer_adapt_v17_fbdb_pilot_v17a",
        "tag_prefix": "tmmeada_transfer_adapt_v17_fbdb_v17a",
        "pilot_ref_dir": ROOT / "runs/transfer/transfer_adapt_v17_fbdb_v17a_pilot_ref/target_eval",
        "full_ref_dir": ROOT / "runs/transfer/transfer_adapt_v17_fbdb_v17a_expand5_ref/target_eval",
        "transfer_skip_keys": "multimodal_encoder.entity_emb.weight",
    },
    "v17b": {
        "config": "configs/transfer_adapt/tmmeada_target_fbdb15k_v17b_late_il_strict.yaml",
        "stage_root": "transfer/transfer_adapt_v17_fbdb_pilot_v17b",
        "tag_prefix": "tmmeada_transfer_adapt_v17_fbdb_v17b",
        "pilot_ref_dir": ROOT / "runs/transfer/transfer_adapt_v17_fbdb_v17b_pilot_ref/target_eval",
        "full_ref_dir": ROOT / "runs/transfer/transfer_adapt_v17_fbdb_v17b_expand5_ref/target_eval",
        "transfer_skip_keys": "multimodal_encoder.entity_emb.weight",
    },
    "v17c": {
        "config": "configs/transfer_adapt/tmmeada_target_fbdb15k_v17c_late_il_skiprel.yaml",
        "stage_root": "transfer/transfer_adapt_v17_fbdb_pilot_v17c",
        "tag_prefix": "tmmeada_transfer_adapt_v17_fbdb_v17c",
        "pilot_ref_dir": ROOT / "runs/transfer/transfer_adapt_v17_fbdb_v17c_pilot_ref/target_eval",
        "full_ref_dir": ROOT / "runs/transfer/transfer_adapt_v17_fbdb_v17c_expand5_ref/target_eval",
        "transfer_skip_keys": (
...
def main():
    parser = argparse.ArgumentParser(description="Iterate FBDB15K v17 noise-control variants with resumable summaries.")
    parser.add_argument(
        "--run-missing",
        type=int,
        default=1,
    ...
    baseline_pilot_all_ref = ROOT / "runs/transfer/transfer_adapt_v17_fbdb_pilot_baseline_ref/target_eval"
    ...
    for key in ["v17a", "v17b", "v17c"]:
        ...
        compare_csv = None
        delta = None
        baseline_variant_ref = ROOT / "runs/transfer" / f"transfer_adapt_v17_fbdb_{key}_pilot_baseline_matched_ref" / "target_eval"
        if selected_seeds:
        ...
        if baseline_pilot_selected and selected:
            compare_csv_path = summarize_compare(
                prefix=f"transfer_adapt_v17_fbdb_pilot_{key}",
    ...
    if should_expand:
        ...
        if best_selected_seeds:
            best_baseline_ref = ROOT / "runs/transfer" / f"transfer_adapt_v17_fbdb_{best_variant}_expand5_baseline_matched_ref" / "target_eval"
        ...
        if best_baseline_selected and best_selected:
            compare_csv = summarize_compare(
                prefix=f"transfer_adapt_v17_fbdb_{best_variant}_expand5",
    ...
    out_json = ROOT / "reports/transfer/transfer_adapt_v17_fbdb_iter_decision.json"
    out_md = ROOT / "reports/transfer/transfer_adapt_v17_fbdb_iter_decision.md"
