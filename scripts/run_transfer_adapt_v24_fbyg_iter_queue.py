...
CURRENT_BEST_COMPARE_CSV = ROOT / "reports/transfer/transfer_adapt_v23_fbyg_v23b_expand5_compare_vs_baseline.csv"
...
VARIANTS = {
    "v24a": {
        "config": "configs/transfer_adapt/tmmeada_target_fbyg15k_v24a_strictsrc_staged_fresh_il_top250.yaml",
        "stage_root": "transfer/transfer_adapt_v24_fbyg_pilot_v24a",
        "tag_prefix": "tmmeada_transfer_adapt_v24_fbyg_v24a",
        "pilot_ref_dir": ROOT / "runs/transfer/transfer_adapt_v24_fbyg_v24a_pilot_ref/target_eval",
        "full_ref_dir": ROOT / "runs/transfer/transfer_adapt_v24_fbyg_v24a_expand5_ref/target_eval",
        "transfer_skip_keys": (
    ...
    "v24b": {
        "config": "configs/transfer_adapt/tmmeada_target_fbyg15k_v24b_strictsrc_staged_fresh_il_top400.yaml",
        "stage_root": "transfer/transfer_adapt_v24_fbyg_pilot_v24b",
        "tag_prefix": "tmmeada_transfer_adapt_v24_fbyg_v24b",
        "pilot_ref_dir": ROOT / "runs/transfer/transfer_adapt_v24_fbyg_v24b_pilot_ref/target_eval",
        "full_ref_dir": ROOT / "runs/transfer/transfer_adapt_v24_fbyg_v24b_expand5_ref/target_eval",
        "transfer_skip_keys": (
            "multimodal_encoder.entity_emb.weight,"
            "multimodal_encoder.rel_fc.weight,"
            "multimodal_encoder.rel_fc.bias"
    ...
    "v24c": {
        "config": "configs/transfer_adapt/tmmeada_target_fbyg15k_v24c_strictsrc_staged_fresh_il_epoch8_top250.yaml",
        "stage_root": "transfer/transfer_adapt_v24_fbyg_pilot_v24c",
        "tag_prefix": "tmmeada_transfer_adapt_v24_fbyg_v24c",
        "pilot_ref_dir": ROOT / "runs/transfer/transfer_adapt_v24_fbyg_v24c_pilot_ref/target_eval",
        "full_ref_dir": ROOT / "runs/transfer/transfer_adapt_v24_fbyg_v24c_expand5_ref/target_eval",
        "transfer_skip_keys": (
            "multimodal_encoder.entity_emb.weight,"
            "multimodal_encoder.rel_fc.weight,"
            "multimodal_encoder.rel_fc.bias"
...
def main():
    parser = argparse.ArgumentParser(description="Iterate FBYG15K v24 strict-source staged fresh-IL variants with resumable pilot/full5 summaries.")
    ...
    baseline_pilot_all_ref = ROOT / "runs/transfer/transfer_adapt_v24_fbyg_pilot_baseline_ref/target_eval"
    ...
    for key in ["v24a", "v24b", "v24c"]:
        ...
        compare_csv = None
        delta = None
        baseline_variant_ref = ROOT / "runs/transfer" / f"transfer_adapt_v24_fbyg_{key}_pilot_baseline_matched_ref" / "target_eval"
        if selected_seeds:
        ...
        if baseline_pilot_selected and selected:
            compare_csv_path = summarize_compare(
                prefix=f"transfer_adapt_v24_fbyg_pilot_{key}",
    ...
    if (
        ...
        selected_seeds = seed_list_from_selected(selected)
        baseline_full_ref = ROOT / "runs/transfer" / f"transfer_adapt_v24_fbyg_{best_variant}_expand5_baseline_matched_ref" / "target_eval"
        if selected_seeds:
        ...
        if baseline_selected and selected:
            compare_csv_path = summarize_compare(
                prefix=f"transfer_adapt_v24_fbyg_{best_variant}_expand5",
    ...
    json_path = ROOT / "reports/transfer/transfer_adapt_v24_fbyg_iter_decision.json"
    md_path = ROOT / "reports/transfer/transfer_adapt_v24_fbyg_iter_decision.md"
    ...
    lines = [
        ...
        f"- reference_delta_avg_mrr_mean(v23_expand5): `{ref_delta}`",
