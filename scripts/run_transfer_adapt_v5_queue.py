...
def run_one(seed: int, runner_python: str, meaformer_python: str, stage_root: str):
    ...
    cmd = [
        ...
        target_cfgs,
        "--tag",
        f"tmmeada_transfer_adapt_v5_s{seed}",
        "--stage-root",
        stage_root,
        "--seed",
        str(seed),
...
def main():
    parser = argparse.ArgumentParser(
        description="Run transfer adapt v5 queue on ja_en and FBDB15K (TMMEA-DA only)."
    )
    ...
    parser.add_argument("--stage-root", default="transfer/transfer_adapt_v5")
    ...
    print("[DONE] transfer adapt v5 queue completed.")
