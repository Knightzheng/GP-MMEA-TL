...
def main():
    baseline = read_row(Path("reports/baseline/meaformer_results_mean_std.csv"))
    v0 = read_row(Path("reports/tmmeada/tmmeada_results_mean_std.csv"))
    v1 = read_row(Path("reports/tmmeada/tmmeada_v1_results_mean_std.csv"))
    v1_best = read_row(Path("reports/tmmeada/tmmeada_v1_best_results_mean_std.csv"))

    out_csv = Path("reports/tmmeada/tmmeada_v1_best_compare_zh_en.csv")
    out_md = Path("reports/tmmeada/tmmeada_v1_best_compare_zh_en.md")
