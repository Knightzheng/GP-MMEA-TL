...
def main():
    parser = argparse.ArgumentParser(
        description="Resume and expand transfer-adapt v14 (fr_en) from 2-seed to 5-seed."
    )
    ...
    parser.add_argument("--target", default="fr_en")

    parser.add_argument("--baseline-source-config", default="configs/transfer/meaformer_source_zh_en_epoch10.yaml")
    parser.add_argument("--baseline-target-config", default="configs/transfer_adapt/meaformer_target_fr_en_unsup_il.yaml")
    parser.add_argument("--tmmeada-source-config", default="configs/transfer/tmmeada_source_zh_en_epoch10.yaml")
    parser.add_argument("--tmmeada-target-config", default="configs/transfer_adapt/tmmeada_target_fr_en_v14b_refresh4_da0025.yaml")

    parser.add_argument("--baseline-stage-root", default="transfer/transfer_adapt_v14_fren_expand5_baseline")
    parser.add_argument("--tmmeada-stage-root", default="transfer/transfer_adapt_v14_fren_expand5_tmmeada")
    ...
    parser.add_argument(
        ...
        default="runs/transfer/transfer_adapt_v14_fren_2seed_v14b_refresh4_da0025/target_eval",
    )
    parser.add_argument(
        "--merged-baseline-target-eval",
        default="runs/transfer/transfer_adapt_v14_fren_expand5_merged_baseline/target_eval",
    )
    parser.add_argument(
        "--merged-tmmeada-target-eval",
        default="runs/transfer/transfer_adapt_v14_fren_expand5_merged_tmmeada/target_eval",
    )
    parser.add_argument(
        "--report-prefix",
        default="reports/transfer/transfer_adapt_v14_fren_expand5_progress",
    )
    parser.add_argument(
        "--status-json",
        default="reports/transfer/transfer_adapt_v14_fren_expand5_status.json",
    )
    parser.add_argument(
        "--status-md",
        default="reports/transfer/transfer_adapt_v14_fren_expand5_status.md",
    )
    parser.add_argument(
        "--run-missing",
        type=int,
        ...
        for seed in seeds:
            if seed in initial_baseline_missing:
                ...
                run_transfer_one(
                    ...
                    tag=f"baseline_transfer_adapt_v14_fren_expand5_s{seed}",
            ...
            if seed in initial_tmmeada_missing:
                ...
                run_transfer_one(
                    ...
                    tag=f"tmmeada_transfer_adapt_v14_fren_expand5_s{seed}",
    ...
    lines = [
        "# Transfer Adapt v14 fr_en Expand5 Status",
        "",
