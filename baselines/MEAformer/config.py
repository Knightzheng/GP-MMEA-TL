...
class cfg():
    ...
    def get_args(self):
        ...
        parser.add_argument("--img_mask_drop_rate", type=float, default=0.0, help="artificially drop a fraction of available images for missing-modality pressure tests")
        parser.add_argument("--img_mask_drop_seed", type=int, default=-1, help="seed for artificial image dropping; -1 falls back to random_seed")
